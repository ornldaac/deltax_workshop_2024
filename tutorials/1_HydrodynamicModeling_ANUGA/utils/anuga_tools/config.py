...
sys.path.append('../')
# importing
from settings import rho_w, CFL
...
eta_w = 1.3e-3  # Wind stress coefficient
rho_a = 1.225  # Atmospheric density
rho_w = rho_w   # Fluid density [kg/m^3] (rho_w = 1023 for salt water)
...
CFL = CFL  # CFL condition assigned to domain.CFL - controls timestep size
